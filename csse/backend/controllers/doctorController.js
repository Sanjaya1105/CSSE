...
exports.getDoctorById = async (req, res) => {
  try {
    const { id } = req.params;
    const doctor = await Doctor.findById(id, '-password');
...
// Get a doctor by register number
exports.getDoctorByRegisterNumber = async (req, res) => {
  try {
    const { registerNumber } = req.params;
    const doctor = await Doctor.findOne({ registerNumber }, '-password');
